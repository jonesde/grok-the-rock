...
Strategy:
- Keep proper noun "Grok" / "Grok la Roca" as recognizable transliteration.
...
LANGS = {
    "fr": {
        "title": "Grok la Roca - Trois Histoires Silencieuses",
    ...
    "de": {
        "title": "Grok la Roca - Drei Stille Geschichten",
    ...
    "it": {
        "title": "Grok la Roca - Tre Storie Silenziose",
    ...
    "pt": {
        "title": "Grok la Roca - Três Histórias Silenciosas",
    ...
    "nl": {
        "title": "Grok la Roca - Drie Stille Verhalen",
    ...
    "ru": {
        "title": "Грок ла Рока - Три Тихие Истории",
    ...
    "ar": {
        "title": "غروك لا روكا - ثلاث قصص صامتة",
...
def main():
    for code, L in LANGS.items():
        lines = [
            ...
            '//',
            '// Convention: keep the proper noun "Grok" / "Grok la Roca" as a',
