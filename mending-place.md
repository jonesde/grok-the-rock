...
- [Part Two: The Ten Rules](#part-two)
    - [The Ten Rules in Short Form](#the-ten-rules-in-short-form)
...
This book stays with that shape. It does not require agreement on larger theological or historical claims. It only requires willingness to test whether the same logic produces better results in ordinary life than the alternatives most of us default to. That logic is simple: heal the root, restore rather than punish, and refuse both false height and collapse.
...
When agency has been violated, shame is the common result. That violation includes being treated as an object, controlled, humiliated, or made invisible. The nervous system records the loss of standing and begins scanning for ways to never feel that small again.
...
| | **Avoid** | **Confront** |
| --- | --- | --- |
| **Active** | **Flight**: active avoidance | **Fight**: active confrontation |
| **Passive** | **Freeze/fawn**: passive avoidance | **Stand**: passive confrontation |

Stand appears in the grid as the fourth posture, but it is the stable, non-aggressive edge. It holds a boundary without becoming fight, and it can precede open connection rather than block it.
...
Diagnostic question: What useful knowledge or capacity am I currently holding in a form that keeps others dependent on me? Is there one piece I could open without harming those I am bound to care for?
...
Adult practice: When the familiar heat or cold of inadequacy appears, do not immediately manage the room or disappear from it. Name the feeling privately (“this is the small feeling”). Stay with it for a measured amount of time (often about ninety seconds) **if you are safe enough to stay**. The goal is not to romanticize shame. The goal is to stop letting threat mode drive the next move, and to return toward connection when the body can.

If you are flooded, frozen, fleeing, or appeasing, reduce threat first (Part One); do not turn “sitting with it” into another performance demand. In that territory, *stand* — holding a real limit without racing into fight — is sometimes the most that is available, and it is still not the same as open connection. It is enough to hold the line until safety returns.
...
1. **Safety and acknowledgment.** The injured partner names the injury without immediately accepting the minimization. A third party who saw it does not pile on for sport; they confirm what happened if asked.
...
- A silent “social contract” in which norms bind people who never agreed to them and cannot leave without damage to their reputation.
...
Sections 1–4 set the field: how the pattern spreads, how to inhabit existing structures, how public conflict is handled, and how the original person or first households stay available without becoming a center. Section 5 is the main shared tool for decisions and multi-party conflict (Planner–Reviewer–Approver). Sections 6–7 are weather reports: resistance and markers of progress or distortion.
...
Early signs density is healthy: the children’s books circulate without a central distributor; mutual aid grows shared capacity more than it lifts anyone’s status. Early signs of distortion: a few official interpreters, belonging tests, or a named inner circle. Full markers of progress and stall appear in section 7.
...
- Document agreements in plain language when money, children, or shared property are involved: not as performance by default, but as shared memory that reduces later rewriting.
...
### 4. The Role of the Original Person or First Households: Available, Not Central

Whoever first carried the material into the community (one person or a first household) has a specific, limited role: remain available for private clarification when someone is stuck, continue practicing, and refuse the invitation to become the indispensable hub. As soon as questions and decisions routinely route through that person or household, a new star has formed.

The healthiest trajectory is that the first carriers become less necessary over time. Others develop equal fluency. The children’s books and the shared rules carry the pattern more than any individual does. When the original person or first households can be absent without the work stalling, the diffusion is succeeding.
...
The first carriers are seed-carriers, not suns. Seeds that demand permanent orbit have already failed the sixth and tenth rules.
...
3. Approvers include those whose ongoing work and trust are required for any path forward. That often means both the injured teammates and, where safe, the person who failed, if they are still in relationship.
...
- The exclusion spiral from Rule 9: the circle shrinks by removal and labels the smaller result “purity.”
...
4. Keep a path of return open (depends on demonstrated change, not unlimited cost).
5. Use Planner–Reviewer–Approver when a decision must be made among several people.
...
Protective in origin; harmful when fight, flight, or freeze/fawn become the only available weather. Stand is the stable edge; connection is a separate return state. These are not free moral programs. Standing at scale is treated under Rule 3.
