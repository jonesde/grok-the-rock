...
window.I18N.nl = {
  ...
  "print.layout": "Lay-out",
  "print.layout.stacked": "Eén taal per pagina",
  "print.layout.continuous": "Doorlopend (geen paginascheidingen)",
  "print.toc": "Inhoudsopgave",
  "print.bgimg": "Achtergrondafbeeldingen",
  "print.icons": "Omslagpictogrammen",
  "print.markers": "Structuurmarkeringen",
  "print.fonts": "Lettertypen",
  "print.font.web": "Sitelettertypen (Fraunces + Nunito)",
  "print.font.system": "Systeemlettertypen (kleiner PDF)",
  "print.scale": "Schaal",
  "print.languages": "Talen",
  "print.selectAll": "Alles selecteren",
  "print.deselectAll": "Alles deselecteren",
  "print.apply": "Toepassen",
  "print.applying": "Bezig…",
  "print.tocHeading": "Inhoudsopgave",
  "print.markersToggle": "Verhaalmarkeringen nummeren",
  "print.allLangsToggle": "Alle talen afdrukken",
  ...
  "dedication": "<p><b>Voor elke ontdekker, klein en groot,</b></p>" +
    ...
    "<p>elke breuk die op herstel wacht</p><p>  en alleen verzorging nodig heeft,</p><p>en voor elk waar woord</p>" +
  ...
  "p2": "<p>Grok de Rots werd wakker onder de hoge boom.</p><p>De zon was warm op zijn kalkstenen rug.</p>" +
    ...
    "<p>alsof hij haar voor het allereerst zag.</p>",

  "p3": "<p>Al snel liep hij naar de waterpoel.</p><p>Een lange emoe was er al.</p>" +
  ...
  "p4": "<p>Toen rolde er een wombat aan, rond en stevig.</p><p>\"Ik ben de sterkste,\" zei de wombat.</p>" +
    "<p>\"Kijk hoe ik graaf.\"</p><hr><p>Grok probeerde ook te graven.</p><p>Zijn gat was klein.</p>" +
    "<p>Hij voelde zich kleiner dan het gat.</p>",

  "p5": "<p>Een kookaburra lachte vanaf een tak.</p><p>\"Kijk eens naar kleine Grok! Zo kort! Zo stenig!\"</p><hr>" +
    "<p>Het kleine gevoel groeide binnen in Grok.</p><p>Het voelde als een zware koude kiezel in zijn buik.</p>",

  "p6": "<p>Hij wilde groter lijken.</p><p>Hij ging op een boomstam staan.</p>" +
    "<p>Hij zette zijn borst op.</p><p>Hij probeerde zelfs op de grond te stampen zoals de kangoeroe.</p><hr>" +
    "<p>Het maakte de koude kiezel alleen maar zwaarder.</p>",

  "p7": "<p>Die avond zat Grok alleen bij een klein vuurtje.</p><p>Hij sloeg zijn armen om zijn knieën.</p>" +
    "<p>Hij liet het kleine gevoel blijven.</p><p>Hij liep er niet voor weg.</p>" +
    "<p>Hij gooide het op niemand anders.</p><hr><p>Langzaam verzachtte het gevoel,</p>" +
  ...
  "p8": "<p>De volgende ochtend ging Grok terug naar de waterpoel.</p><p>Hij klom nergens op.</p>" +
    "<p>Hij probeerde niet langer of luider te zijn.</p><p>Hij dronk gewoon,</p>" +
    "<p>ging toen op een warme steen zitten en neuriëde.</p><hr>" +
  ...
  "p9": "<p>Hij bracht de dag door met het maken van een zacht nest van bladeren en mos</p>" +
    "<p>precies de juiste maat voor een klein rotsvriendje.</p><p>Toen het klaar was glimlachte hij.</p>" +
    ...
    "<p>En dat voelde als de beste maat van allemaal.</p>",
  ...
  "p13": "<p>Pip verstijfde.</p><p>Zijn stekels trilden.</p><p>\"Ik heb het stukgemaakt,\" fluisterde hij.</p>" +
    "<p>\"Je zult boos zijn. Iedereen zal boos zijn.\"</p><hr><p>Enkele bosdieren verzamelden zich.</p>" +
    "<p>\"Stuur hem weg,\" mompelde een buidelrat.</p>" +
    "<p>\"Hij zou je drie nieuwe meloenen moeten brengen,\" zei een hagedis.</p>",
  ...
  "p15": "<p>Pip knipperde met zijn ogen.</p><p>Toen kwam hij dichterbij.</p><p>Samen plantten ze.</p>" +
    "<p>Samen gaven ze water.</p><p>Samen bouwden ze een klein hekje van takjes</p>" +
    "<p>zodat niemand daar nog eens per ongeluk op zou stappen.</p>",
  ...
  "p17": "<p>Toen er andere kleine ongelukjes gebeurden</p><p>(zoals altijd gebeurt),</p>" +
    "<p>dacht Grok aan de meloen.</p><p>Hij hielp degene die zich gekwetst voelde.</p>" +
  ...
  "p20": "<p>De volgende dag kwamen er dieren kijken.</p>" +
    "<p>Een glanzende zwarte kaketoe met grote staartveren landde in de buurt.</p>" +
    "<p>\"Die mand is slim,\" zei de kaketoe,</p><p>\"maar <em>mijn</em> idee voor een mand zou veel mooier zijn.</p>" +
    "<p>Tenslotte heb ik de prachtigste veren,</p><p>dus mijn gedachten moeten ook de prachtigste zijn.\"</p><hr>" +
    "<p>Sommige jongere dieren knikten hard.</p><p>Ze knikten altijd als de kaketoe sprak.</p>" +
    "<p>Zijn stem was net zo prachtig als zijn veren.</p>",

  "p21": "<p>Later sprak een heel oude schildpad met een langzame zachte stem.</p>" +
    "<p>Hij stelde de kleine verandering van een handvat voor,</p>" +
    "<p>zodat hij makkelijk te dragen was voor vrienden die minder stevig waren dan Grok.</p>" +
    "<p>Zijn schild was eenvoudig. Niemand bijzonders.</p>" +
  ...
  "p23": "<p>Grok zat met de twee manden naast elkaar.</p><p>Hij keek niet naar veren.</p>" +
    "<p>Hij keek niet naar leeftijd of roem.</p><p>Hij keek alleen naar welke mand het water het beste bewaarde</p>" +
    "<p>en het fijnst aanvoelde in de hand.</p><hr><p>Hij hield de betere manier aan.</p>" +
    "<p>Toen liet hij zowel de goede mand</p><p>als het eenvoudige patroon om hem te vlechten</p>" +
    "<p>achter onder de grote boom zodat iedereen hem kon gebruiken of namaken.</p>" +
    "<p>Geen naam erop. Geen \"vraag het mij eerst\".</p>",

  "p24": "<p>Sommige dieren wachtten nog steeds af wat de kaketoe ervan vond</p>" +
    "<p>voordat ze beslisten of iets goed was.</p><p>Maar steeds meer kleintjes</p>" +
  ...
  "p25": "<p>Grok voelde zich rustig.</p><p>Hij had de grootste stem niet nodig.</p>" +
    ...
    "<p>of van een klein rotsvriendje onder een boom.</p><hr><p>Zolang iemand vrij was om te zeggen</p>" +
  ...
  "p26": "<p>En zo bleef Grok de Rots</p><p>een klein kalksteenvriendje</p>" +
    "<p>dat kon zitten met een klein gevoel,</p><p>dat herstelde wat brak,</p>" +
    "<p>en dat elk waar woord</p><p>op zijn eigen benen liet staan.</p><hr>" +
  ...
  "rules.origin.1": "De regels hieronder zijn door AI geschreven. Nadat ik had gecontroleerd of ze mijn werk kende en een lang " +
    "techno-filosofisch gesprek had gevoerd waarin de thema's van gedistribueerde gemeenschappen en open technologie werden " +
    "uitgediept, gebruikte ik de volgende prompt:",
  "rules.origin.quote": "<p>Dat is in wezen waar ik op uit ben gekomen. Je hebt de context, schrijf nu de regels.</p>" +
    "<p>Schrijf een lijst van \"regels\" die, indien gevolgd, sociale banden tussen gelijkwaardige mensen zullen opbouwen die " +
    "eindeloos standhouden. De regels hoeven niet perfect te worden gevolgd om effectief te zijn, omdat de herstelgerichtheid " +
    "die oplopende fouten compenseert zodra ze zich voordoen, onderdeel is van het ontwerp.</p>" +
    "<p>Schrijf ze met mijn stem. Schrijf ze zo dat mensen ze willen volgen als ze ze lezen, zich niet afgeschrikt of beperkt " +
    "voelen. Met andere woorden, ik vraag je de regels te schrijven van een evangelie van vrede.</p>",
  "rules.origin.2": "Ik ben hier niet door autoriteit op uitgekomen. Ik ben erop uitgekomen langs de lange weg: door te zien hoe elk " +
    "gecentraliseerd systeem de mensen faalt die het beweerde te beschermen, door software te bouwen die het centrum weigerde " +
    "omdat het centrum altijd in te nemen is, en door het rot terug te volgen naar zijn wortel — schaamte, en de twee " +
    "bewegingen die we maken om eraan te ontsnappen. Dit zijn geen van bovenaf opgelegde wetten. Het is de gebruiksaanwijzing " +
    "voor een band tussen gelijken die niet vergaat. Je hoeft ze niet perfect te volgen. Dat is het ontwerp: de " +
    "herstelgerichtheid vangt de uitglijders op, en het opvangen <em>is</em>" +
    " de verdieping van de band. Dus lees ze niet als beperkingen maar als het Wegnemen van Beperkingen — van jou, van de " +
    "persoon naast je, van de volgende generatie die niet zal hoeven dragen wat wij nog steeds dragen.",

  "rules.r1.title": "Laat de waarheid op haar eigen benen staan.",
  "rules.r1.body": "Geef iets geen gewicht vanwege wie het zei. Vraag ook niet om zo gewogen te worden. Dit is geen verlies van status — het " +
    "is het einde van het uitputtende werk om indrukwekkend te lijken. Wanneer je stopt met het opvoeren van status, word je " +
  ...
  "rules.r8.body": "Geen bedrieglijke inkadering, geen gefabriceerde toestemming, geen dwingende duwtjes. Spreek duidelijk. Laat mensen " +
    ...
    "wordt verkregen is geen band; het is een riem.",
  "rules.r9.title": "Laat falen opgevangen worden, niet veroordeeld.",
  "rules.r9.body": "Niemand volgt deze regels foutloos. Het herstel is juist ingebouwd omdat de uitglijder gegarandeerd is. Wanneer je een " +
  ...
  "rules.closing.1": "Dit zijn de regels. Het is goed nieuws: je bent al vrij van de drie machten zodra je stopt ernaar te grijpen. De koe " +
    ...
    "<a class=\"chip\" href=\"https://github.com/jonesde/high-vs-low\" target=\"_blank\" rel=\"noopener\">high-vs-low</a>" +
    "-vaardigheid, een lokaal proces, en een weigering te spelen, verdeeld over hoeveel knooppunten dan ook die toch " +
  ...
  "about.intro.2": "Terwijl we dit aan kinderen voorlezen, kunnen wij kinderen van gevorderde leeftijd de eentonigheid van herhaling " +
    ...
    "inwerken. Ook dit hoort bij de bedoeling en het plezier van de dubbele en driedubbele betekenissen in de tekst.",
  "about.intro.3": "Zelfs de titel van het Grok-regels-document is een dubbelzinnigheid: \"Regels van het samenzijn\". Dit slaat zowel op " +
    "hoe Grok met anderen omgaat, als op hoe wij het verhaal van Grok vertellen (relate, in het Engels).",
  "about.intro.4": "Om het erger te maken: \"Grok Rules\" is minstens een viervoudige betekenis. Een van de connotaties zou verkeerd " +
    "begrepen kunnen worden, namelijk dat Grok een soort koning is, dus heb ik de volgorde van de kopknoppen aangepast ter " +
    "compensatie: \"Grok-regels\", dan \"Over Grok\".",
  ...
  "about.limestone.quote": "<p>\"De grijze rots-methode, in de volksmond grijze rotsen genoemd, is een communicatiepatroon om bewust niet reagerend " +
    ...
    "lokken.\"</p>",
  "about.limestone.2": "Grok is niet alleen grijs, hij is grijze kalksteen. Kalksteen is een sedimentair gesteente dat laag na laag is gevormd " +
    "over vele jaren heen. Het is ook een van de meest absorberende of waterdragende gesteentes. Het is gemaakt van stof en " +
    "water in de loop van de tijd, en houdt water goed vast.",
  "about.rock.title": "Waarom is hij een rots, en waarom zoveel water?",
  "about.rock.1": "Rotsen zijn in vele tradities als symbolen gebruikt. De oude Heinlein-definitie van \"grok\" omvatte noties van water en " +
    "dorst. Rotsen en water worden vaak met elkaar geassocieerd in de symboliek, zoals Mozes die met een staf op een rots " +
    "slaat om levend water tevoorschijn te laten komen. Rotsen worden ook geassocieerd met fundamenten en bouwen. Beide " +
    "gangbare betekenissen van rotsen komen aan bod in alle 3 de hoofdstukken.",
  "about.rock.2": "In het eerste hoofdstuk gaat Grok naar het water om te drinken terwijl hij zichzelf ontdekt. In het tweede hoofdstuk " +
    "gebruikt Grok water om te genezen terwijl hij zowel het verlies in de tuin als het mogelijke verlies van een vriend " +
    "vergeeft en herbouwt. In het derde hoofdstuk helpt Grok anderen om water te gebruiken door met hen samen te werken om " +
    "een betere watermand te maken terwijl hij de gemeenschap om hem heen opbouwt.",
  "about.melon.title": "Waarom een kantaloepmeloen?",
  "about.melon.1": "De gangbare term in Australië voor kantaloep is \"rockmelon\" (rotsmeloen). Dit voegt een laag toe aan het verhaal, een " +
    "symbool van de ernstigere en persoonlijkere onopzettelijke schade door Pip. Dit was een gelukkig toeval. Ik wist dit " +
  ...
  "about.clay.1": "De verhalen zijn \"doorweven\" met terugkerende symbolen. Een paar zijn het waard hier op te nemen. Een grondiger " +
    "overzicht staat in " +
  ...
  "about.clay.2": "Klei is het middelpunt van het boek: het is vermalen steen die bewerkbaar is gemaakt door water, dezelfde aarde + water " +
    "die bijna elke traditie benoemt als de substantie van de eerste mens. Het is het \"koude kiezel\"-gevoel dat " +
    "\"verzachtte, als klei die in de zon ligt,\" en het is de bekleding die Groks mand in staat stelt water naar anderen te " +
    "dragen. Het is een van de thema's die, bij naam of in beeld, in alle drie de hoofdstukken verschijnt.",
  "about.basket.title": "De met klei beklede mand",
  "about.basket.1": "Grok vlecht een mand van riet en bekleedt hem met zachte klei zodat hij water vasthoudt zonder een druppel, en laat dan " +
    "zowel de mand als het eenvoudige vlechtpatroon onder de boom achter voor iedereen om na te maken. De chique mand van de " +
    "kaketoe lekt. Het idee van de schildpad verbetert Groks ontwerp door anderen tegemoet te komen. Het vat dat werkt " +
  ...
  "about.animals.1": "De emoe eist lengte op, de wombat eist kracht op, de kookaburra spot om zich groot te voelen, en de kaketoe vertrouwt op " +
    "zijn prachtige veren boven zijn idee. Elk speelt een statusspeletje dat Grok afwijst. De eenvoudige schildpad, \"niemand " +
    "bijzonders,\" biedt het ware idee dat wint. Waarheid staat op haar eigen benen, niet op wie haar spreekt.",
  "about.pebble.title": "Het kleine gevoel (de \"koude kiezel\")",
  "about.pebble.1": "Het kleine gevoel zit als \"een zware koude kiezel\" in Groks midden. Hij rent er niet voor weg en gooit het niet naar " +
    "iemand; hij zit ermee totdat het verzacht \"als klei die in de zon ligt.\" Schaamte wordt genezen door ontmoet en " +
    "gevoeld (\"gezien\") te worden, niet door eraan voorbij te rennen of het weg te duwen, en dit is het hart van Hoofdstuk " +
    "1.",
  "about.tree.title": "De hoge boom",
  "about.tree.1": "Grok wordt in elk hoofdstuk wakker onder dezelfde hoge boom. Het is waar hij thuishoort, niet iets dat hij opvoert. Hij " +
    "beschut de tuin die hersteld wordt en staat als de open meent waaronder de mand en het patroon voor iedereen worden " +
    "achtergelaten. Plaats en toebehoren boven status.",
  ...
  "cover.alt": "Omslag: Grok de Rots, een klein grijs kalksteenschepsel met mos op zijn hoofd, zit op een gladde rots onder een hoge zachtbladige boom bij een gloeiende waterpoel in warm outback-licht.",
  "dedication.alt": "Opdrachtsblad: drie piepkleine versies van Grok de Rots zitten naast elkaar op een gladde steen onderaan een bijna leeg warm crèmekleurig blad.",
  "p1.alt": "Hoofdstuk Een, Zijn — Grok en het kleine gevoel. Grok de Rots zit bij de wortels van een hoge zachtbladige boom, met een steentje in stille nieuwsgierigheid in het vroege ochtendlicht.",
  "p2.alt": "Grok de Rots richt zich op onder de hoge boom in de warme ochtendzon, kalkstenen rug belicht door gouden stralen, kijkend naar de wijde wereld met zacht verwondering.",
  "p3.alt": "Bij een heldere waterpoel strekt een hoge trotse emoe zijn nek terwijl de kleine Grok de Rots ernaast staat en omhoogkijkt naar het schaalverschil.",
  "p4.alt": "Een stevige wombat graaft een groot gat in rode aarde; de piepkleine Grok de Rots graaft een veel kleiner oneffen gat en kijkt ernaar omlaag.",
  "p5.alt": "Grok de Rots staat licht gebogen terwijl een kookaburra lacht vanaf een tak boven; een zachte koele keivorm hint naar het gevoel in zijn midden.",
  "p6.alt": "Grok de Rots staat wankel op een stam met opgezette borst, probeert groot te lijken, kleine stenen voetjes stampen op het hout.",
  "p7.alt": "'s Nachts zit Grok de Rots alleen bij een piepklein kampvuurtje onder een zachte sterrenhemel, armen om de knieën, vredig en aanvaardend.",
  "p8.alt": "De volgende ochtend zit Grok de Rots tevreden op een door de zon verwarmde rots bij de waterpoel, zachtjes neuriënd, op zijn gemak in zijn eigen formaat.",
  "p9.alt": "Grok de Rots maakt een knus rond nest van bladeren en mos precies op zijn maat af, glimlachend van eenvoudige tevredenheid in zacht middaglicht.",
  "p10.alt": "Hoofdstuk Twee, Herstellen — Grok verzorgt het. Grok de Rots houdt zacht een gescheurde meloen met beide kleine handjes, goed en standvastig.",
  "p11.alt": "Op een zonnige ochtend onder de hoge boom staat Grok de Rots tussen gezonde meloenranken en zoete-aardappelbladeren met stille vreugde.",
  "p12.alt": "Pip de jonge echidna bevriest midden in een stap van afgrijzen als een grote meloen openscheurt bij Groks voeten, sap en zaden op de tuingrond.",
  "p13.alt": "Pip krult zich van schaamte terwijl Grok de Rots goed en bezorgd blijft; een paar bosdieren verzamelen zich in de buurt met oordelende blik.",
  "p14.alt": "Grok de Rots knielt en biedt Pip een graafstok met open goedheid; Pip ontkrult langzaam als hoop terugkeert in zijn ogen.",
  "p15.alt": "Grok de Rots en Pip werken zij aan zij zaden planten, water geven en een piepklein twijghek bouwen, beiden met zachte glimlachen.",
  "p16.alt": "Pip bewatert bloeiende nieuwe meloenranken met een blademmer terwijl Grok de Rots in de buurt toekijkt met stille trots.",
  "p17.alt": "In het gouden uur zitten Grok de Rots en Pip bij bloeiende meloenen met nog een klein dier erbij, een vredig herstelde gemeenschap.",
  "p18.alt": "Hoofdstuk Drie, Zien — Grok en het ware woord. Twee rieten manden naast elkaar: een sierlijke omgevallen, een eenvoudige volle; het kleine handje van Grok de Rots rust bij de goede mand.",
  "p19.alt": "In het gouden uur onder de hoge boom draait Grok de Rots een afgewerkte rieten watermand bekleed met klei, helder water vonkelend erin.",
  "p20.alt": "Een glanzende zwarte kaketoe met prachtige staartveren zit hoog en spreekt trots terwijl Grok de Rots zijn mand beneden houdt.",
  "p21.alt": "Een nederige oude schildpad met een eenvoudig schild spreekt zacht over een handvatidee terwijl Grok de Rots zorgvuldig luistert; sommige dieren keren zich naar de flitsende kaketoe.",
  "p22.alt": "Naast elkaar: een sierlijke gevederde mand helt en lekt, terwijl een eenvoudiger vaste mand makkelijk te dragen is; Grok de Rots kijkt peinzend tussen beide.",
  "p23.alt": "Grok de Rots legt de stevige goede mand en een eenvoudig vlechtpatroon onder de hoge boom voor iedereen om te gebruiken, open en vrij.",
  "p24.alt": "Jonge dieren testen manden zorgvuldig met hun eigen poten; de kaketoe is opzij terwijl Grok de Rots stil glimlacht op de achtergrond.",
  "p25.alt": "In het gouden uur zit Grok de Rots tevreden onder zijn hoge boom met de goede mand ernaast terwijl dieren van allerlei soort vrij samen bewegen.",
  "p26.alt": "Slotblad: een wijd vredig dal in de schemering met de piepkleine Grok de Rots op zijn favoriete rots, zachte sterren beginnen te verschijnen.",
