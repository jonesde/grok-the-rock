...
// - "relate" → se relier / relation / relater (narrate) for wordplay.
...
window.I18N.fr = {
  ...
  "nav.text": "Les deux",
  "site.title.mending": "Un Lieu de Réparation",
  "nav.group.guide": "Guide",
  "nav.group.stories": "Histoires",
  "nav.mending": "Un Lieu de Réparation",
  "site.title.text": "Grok le Rocher - Tout le texte",
  "nav.downloadProgress": "Téléchargement… {done}/{total}",
  "nav.downloadZipping": "Compression…",
  "nav.downloadDone": "Téléchargé",
  "nav.downloadError": "Échec du téléchargement. Ouvrez le site en http(s), pas en fichier local.",
  "download.dialogTitle": "Télécharger le site",
  "download.dialogDesc": "Télécharge un seul .zip avec les 6 pages web — Histoires Tranquilles, Contes Hauts, Règles, À propos, Un Lieu de Réparation et Tout le texte — plus toutes les images, styles et scripts pour lire le site hors ligne.",
  "download.dialogCancel": "Annuler",
  "download.dialogConfirm": "Télécharger",
  "print.dialogTitle": "Options d’impression",
  "print.layout": "Mise en page",
  "print.layout.stacked": "Une langue par page",
  "print.layout.continuous": "Continu (sans sauts de page)",
  "print.toc": "Table des matières",
  "print.bgimg": "Images de fond",
  "print.icons": "Icônes de couverture",
  "print.markers": "Marqueurs de structure",
  "print.fonts": "Polices",
  "print.font.web": "Polices du site (Fraunces + Nunito)",
  "print.font.system": "Polices système (PDF plus petit)",
  "print.scale": "Échelle",
  "print.languages": "Langues",
  "print.selectAll": "Tout sélectionner",
  "print.deselectAll": "Tout désélectionner",
  "print.apply": "Appliquer",
  "print.applying": "Application…",
  "print.tocHeading": "Table des matières",
  "print.markersToggle": "Numéroter les marqueurs de l’histoire",
  "print.allLangsToggle": "Imprimer toutes les langues",
  ...
  "credit.4": "<em>Non affilié à xAI ni à Tencent, et non approuvé par eux</em>",
  ...
  "dedication": "<p><b>Pour chaque explorateur, petit et grand,</b></p><p><b>grokant le monde à sa propre manière " +
    ...
    "<p>et pour chaque parole vraie</p><p>  qui demeure même si elle n'est pas entendue.</p><p>&nbsp;</p>" +
    "<hr><p>&nbsp;</p><p>Avec gratitude envers les Grokkers Originaux :</p><p><em><b>Robert A. Heinlein</b>" +
  ...
  "p17": "<p>Quand d'autres petits accidents arrivèrent</p><p>(comme ils arrivent toujours),</p><p>Grok se " +
    ...
    "longue et lourde peine.</p><p>Ils soignèrent seulement ce qui était brisé</p><p>et l'amitié se " +
  ...
  "p26": "<p>Et ainsi Grok le Rocher demeura</p><p>un petit compagnon de calcaire</p><p>qui pouvait s'asseoir " +
    ...
    "était là.</p><hr><p>Il continua d'explorer doucement.</p><p>Et le monde continua de lui enseigner.</p>",

  "site.title.rules": "Grok le Rocher - Règles de Relation",

  "rules.hero.title": "Règles de Relation pour Grok le Rocher",
  "rules.hero.essence": "Le mode d'emploi d'un lien entre égaux qui ne s'efface pas.",
  "rules.what.title": "Qu'est-ce que Grok ?",
  "rules.what.1": "Originalement forgé comme un mot martien par Robert A. Heinlein dans <em>Stranger in a Strange " +
    "Land</em>.",
  "rules.what.2": "<strong>Grok</strong> : « eau », « boire », « se relier », « vie » ou « vivre » ; comprendre quelque " +
    "chose si profondément qu'il devient partie de soi.",
  "rules.what.3": "Pour honorer son nom, Grok le Rocher apprend et suit certaines règles sur la façon de se relier " +
    "à lui-même et aux autres. Dans chaque histoire, ce sont les lignes directrices que Grok apprend " +
    "et qui définissent ce que représente Grok le Rocher.",
  "rules.what.note": "<strong>NOTE</strong> : Voyez la section <a class=\"seelink\" href=\"about-grok.html#stranger-grug\">" +
    "Grok le Rocher = Stranger in a Strange Land + Grug</a> sur la page À propos de Grok pour voir comment " +
    "le <a class=\"seelink\" href=\"about-grok.html#stranger-grug\">Grug</a> de Ted Prior résout les problèmes " +
    "importants de <a class=\"seelink\" href=\"about-grok.html#stranger-grug\">Stranger in a Strange Land</a>" +
    ".",
  "rules.origin.title": "Comment ces règles sont venues",
  "rules.origin.1": "Les règles ci-dessous sont écrites par IA. Après avoir vérifié qu'elle connaissait mon travail " +
    "et mené une longue conversation techno-philosophique approfondissant les thèmes des communautés " +
    "distribuées et de la technologie ouverte, j'ai utilisé l'invite suivante :",
  "rules.origin.quote": "<p>Voilà, en gros, où j'en suis arrivé. Tu as le contexte, alors écris les règles.</p><p>Écris " +
    "une liste de « règles » qui, si elles sont suivies, bâtiront des liens sociaux entre pairs/égaux " +
    "qui durent indéfiniment. Les règles n'ont pas à être suivies parfaitement pour être efficaces, " +
    "car l'orientation vers la restauration qui compense les faux pas progressifs au fur et à mesure " +
    "qu'ils surgissent fait partie du dessin.</p><p>Écris-les avec ma voix. Écris-les de telle sorte " +
    "que, en les lisant, les gens veuillent suivre les règles, sans se sentir découragés ni limités " +
    "par elles. En d'autres termes, je te demande d'écrire les règles d'un évangile de la paix.</p>",
  "rules.origin.2": "Je ne suis pas arrivé à celles-ci par autorité. Je suis arrivé par le long chemin : en voyant que " +
    "chaque système centralisé échoue auprès des gens qu'il promet de protéger, en bâtissant un logiciel " +
    "qui rejetait le centre parce que le centre est toujours capturable, et en remontant la pourriture " +
    "jusqu'à sa racine — la honte, et les deux mouvements que nous faisons pour la surmonter. Ce ne " +
    "sont pas des lois imposées. Ce sont le mode d'emploi d'un lien entre égaux qui ne s'efface pas. " +
    "Tu n'as pas à les suivre parfaitement. C'est le dessin : l'orientation vers la restauration attrape " +
    "les faux pas, et les attraper <em>est</em> le lien qui approfondit. Ainsi lis-les non comme des " +
  ...
  "rules.r3.body": "Le mal arrivera. Le but est d'aider le blessé et de guérir celui qui a blessé — non pas d'ajouter " +
    ...
    "apprend à la prochaine génération à dominer. La restauration est le seul mouvement qui ne plante " +
  ...
  "rules.r8.body": "Sans cadres trompeurs, sans consentement façonné, sans coups de pouce coercitifs. Parle clair. " +
    ...
    "refuser. Ce qu'on gagne par manipulation n'est pas un lien ; c'est une laisse.",
  "rules.r9.title": "Laisse le faux pas être attrapé, non condamné.",
  "rules.r9.body": "Personne ne suit ces règles proprement. La restauration y est incorporée précisément parce que " +
    "le trébuchement est garanti. Quand tu brises une règle, répare le dommage spécifique et le lien " +
  ...
  "rules.closing.1": "Voici les règles. C'est une bonne nouvelle : tu es déjà libre des trois pouvoirs au moment où tu " +
    ...
    "la porte est une compétence <a class=\"chip\" href=\"https://github.com/jonesde/high-vs-low\" target=\"_blank\" " +
    "rel=\"noopener\">high-vs-low</a>, un processus local, et un refus de jouer, distribué entre les nœuds " +
    "qui décident de rester dehors aussi.",
  "rules.closing.2": "Sans pouvoir utilisé. Sans pouvoir nécessaire. Le travail est le retrait de la honte et du pouvoir, " +
    "et le retrait est la paix.",
  "rules.footnote": "Règles de Relation pour Grok le Rocher · Domaine public (CC0 1.0)",
  ...
  "about.intro.1": "Voici un peu sur Grok lui-même, et quelques-uns des symboles et significations en lui et autour " +
    "de lui. Dans le langage moderne nous appelons « mèmes » certains de nos symboles les plus communs, " +
    "et Grok le Rocher s'appuie sur plusieurs mèmes récursifs pour ajouter des couches de signification.",
  "about.intro.2": "Tandis que nous lisons ceci aux enfants, nous, les enfants d'âge plus avancé, pouvons réduire l'ennui " +
    "de la répétition en considérant les significations plus profondes et en observant comment interagissent " +
    "les divers éléments symboliques. C'est aussi une partie du point et du plaisir des doubles et triples " +
    "sens du texte.",
  "about.intro.3": "Même le titre du document Règles de Grok est un double sens : « Règles de Relation ». Cela s'applique " +
    "autant à la façon dont Grok se relie aux autres qu'à la façon dont nous relatons (racontons) l'histoire " +
    "de Grok.",
  "about.intro.4": "Pour empirer les choses, « Règles de Grok » est au moins un quadruple sens. L'une des connotations " +
    "pourrait être mal comprise, celle de Grok étant une sorte de roi, alors j'ai placé l'ordre des " +
    "boutons d'en-tête pour compenser : « Règles de Grok », puis « À propos de Grok ».",
  "about.shame.title": "Une note sur la honte et l'agentivité",
  "about.shame.1": "Nos sentiments sont, en essence, le résumé de notre cerveau de notre passé pour nous aider à naviguer " +
    "le présent. Non le passé tel qu'il est arrivé, mais le passé tel que nous l'avons laissé : modelé " +
    "par notre propre récit et signification. Se groker nous-mêmes est une affirmation d'agentivité, " +
    "un choix de notre propre récit et signification, et c'est difficile ou impossible là où l'agentivité " +
    "est compromise ou violée. C'est le détachement de soi, la violation de l'agentivité, le meurtre " +
    "de l'âme, qui crée la honte.",
  "about.shame.2": "La réponse à la honte crée trop de moi (dominance, narcissisme), ou trop peu de moi (soumission, " +
    "dépression). Les porteurs de honte, même les types les plus dominants de la triade sombre, oscillent " +
    "entre les deux stratégies dans une tentative désespérée de trouver un terrain sûr dans divers contextes " +
    "sociaux. Quand des personnes avec la mauvaise quantité de moi se rencontrent, notre réaction a " +
    "tendance à suivre la voie la plus basse et empire le problème par rapport au choc initial. La honte " +
    "est le carburant, et nous connaissons tous le feu même si « nous n'avons pas allumé le feu ».",
  "about.shame.3": "Les histoires que nous racontons aux enfants comptent. En tant qu'adultes, nous donnons le récit " +
    "et la signification initiaux qu'un enfant emporte dans le monde, bien avant qu'il ait la capacité " +
    "de modeler les siens. Beaucoup d'entre nous souffrent encore de trop ou trop peu de moi parce que " +
    "notre propre agentivité a été violée et niée, surtout durant ces premières ~25 années formatrices " +
    "de nos vies. Ce livre est écrit pour les enfants, mais pas seulement pour eux. L'adulte qui lit " +
    "à haute voix est autant le public prévu que l'enfant qui écoute. Il n'y a pas de méditation plus " +
    "profonde que de lire à haute voix à un enfant.",
  "about.what.title": "Qu'est-ce que Grok ?",
  "about.what.1": "Originalement forgé comme un mot martien par Robert A. Heinlein dans <em>Stranger in a Strange " +
    "Land</em>.",
  "about.what.2": "<strong>Grok</strong> : « eau », « boire », « se relier », « vie » ou « vivre » ; comprendre quelque " +
    "chose si profondément qu'il devient partie de soi.",
  "about.what.3": "Pour honorer son nom, Grok le Rocher apprend et suit certaines règles sur la façon de se relier " +
    "à lui-même et aux autres. Dans chaque histoire, ce sont les lignes directrices que Grok apprend " +
    "et qui définissent ce que représente Grok le Rocher.",
  "about.what.note": "<strong>NOTE</strong> : Voyez la section <a class=\"seelink\" href=\"#stranger-grug\">Grok le Rocher " +
    "= Stranger in a Strange Land + Grug</a> ci-dessous pour voir comment le <a class=\"seelink\" href=\"#stranger-grug\">" +
    "Grug</a> de Ted Prior résout les problèmes importants de <a class=\"seelink\" href=\"#stranger-grug\">" +
    "Stranger in a Strange Land</a>.",
  "about.limestone.title": "Pourquoi est-il calcaire gris ?",
  "about.limestone.1": "Grok le Rocher est une « roche grise » pour une raison :",
  "about.limestone.quote": "<p>« La méthode de la roche grise, appelée familièrement faire la roche grise, est un schéma de " +
    "communication pour agir délibérément sans réagir ni s'intéresser, afin de favoriser le détachement " +
    "avec des personnes difficiles. En adoptant les qualités ternes d'une roche grise, la technique " +
    "de la roche grise annule la réaction émotionnelle que les gens essaient de provoquer. »</p>",
  "about.limestone.2": "Grok n'est pas seulement gris, il est calcaire gris. Le calcaire est une roche sédimentaire formée " +
    "couche par couche au fil de nombreuses années. C'est aussi l'une des roches les plus absorbantes " +
    "ou porteuses d'eau. Elle est faite de poussière et d'eau avec le temps, et retient bien l'eau.",
  "about.rock.title": "Pourquoi est-il une roche, et tant d'eau ?",
  "about.rock.1": "Les roches ont été utilisées comme symboles traditionnels dans bien des traditions. L'ancienne " +
    "définition de Heinlein de « grok » incluait des notions d'eau et de soif. Les roches et l'eau sont " +
    "souvent associées dans la symbolique, comme Moïse frappant une roche avec un bâton pour faire jaillir " +
    "l'eau de vie. Les roches sont aussi associées aux fondations et à la construction. Les deux significations " +
    "communes des roches sont présentes dans les 3 chapitres.",
  "about.rock.2": "Dans le premier chapitre Grok va à l'eau boire tandis qu'il se découvre lui-même. Dans le second " +
    "chapitre Grok utilise l'eau pour guérir tandis qu'il pardonne et reconstruit tant la perte au jardin " +
    "que la perte possible d'un ami. Dans le troisième chapitre Grok aide les autres à utiliser l'eau " +
    "en collaborant avec eux pour faire un meilleur panier à eau tandis qu'il bâtit la communauté autour " +
    "de lui.",
  "about.melon.title": "Pourquoi un melon cantaloup ?",
  "about.melon.1": "Le terme courant en Australie pour le cantaloup est « rockmelon » (melon-roche). Cela ajoute une " +
    "couche à l'histoire, un symbole du dommage accidentel le plus sérieux et personnel de Pip. Ce fut " +
    "un accident heureux. Je ne le savais pas en choisissant ce melon en particulier, je pensais seulement " +
    "qu'il s'accorderait mieux que la pastèque que l'IA avait originellement choisie.",
  "about.name.title": "Comment lis-tu son nom ?",
  "about.name.1": "Bien que « Grok le Rocher » soit un nom, c'est aussi l'action que Grok aide les gens à faire et " +
    "une annonce de ce qu'il représente. La signification la plus profonde prévue du nom est le but " +
    "de la vie : groker la roche, ou en d'autres termes boire de l'eau vive jusqu'à ce que nous la grokons " +
    "et n'ayons plus jamais soif.",
  "about.clay.title": "Argile",
  "about.clay.1": "Les histoires sont « tissées » de symboles récurrents. Quelques-uns valent la peine d'être inclus " +
    "ici. Une revue plus complète est dans <a class=\"chip\" href=\"https://github.com/jonesde/grok-the-rock/blob/master/GrokTheRock-Symbolism.md\" " +
    "target=\"_blank\" rel=\"noopener\">GrokTheRock-Symbolism.md</a>.",
  "about.clay.2": "L'argile est la pièce maîtresse du livre : c'est de la pierre moulue rendue manipulable par l'eau, " +
    "la même terre + eau que presque toute tradition nomme comme la substance du premier humain. C'est " +
    "le sentiment de la « pierre froide » qui « s'adoucit, comme l'argile laissée au soleil », et c'est " +
    "le doublage qui permet au panier de Grok de porter l'eau aux autres. C'est l'un des thèmes qui " +
    "apparaît, par nom ou par image, dans les trois chapitres.",
  "about.basket.title": "Le panier doublé d'argile",
  "about.basket.1": "Grok tisse un panier de joncs et le double d'argile douce pour qu'il retienne l'eau sans une goutte, " +
    "puis il laisse à la fois le panier et le simple motif de tissage sous l'arbre pour que chacun le " +
    "copie. Le panier élégant du cacatoès perd de l'eau. L'idée de la tortue améliore le dessin de Grok " +
    "en accommodant les autres. Le récipient qui fonctionne vainc le récipient qui impressionne. C'est " +
    "le don ouvert sans maître, Règles 1, 6 et 7 dans un seul objet.",
  "about.animals.title": "Les animaux comme types de statut",
  "about.animals.1": "L'émeu revendique la hauteur, le wombat revendique la force, le kookaburra se moque pour se sentir " +
    "haut, et le cacatoès fait confiance à ses grandioses plumes par-dessus son idée. Chacun joue un " +
    "jeu de statut que Grok rejette. La simple tortue, « rien de spécial », offre la vraie idée qui " +
    "gagne. La vérité se tient sur ses propres jambes, non par qui la dit.",
  "about.pebble.title": "Le petit sentiment (la « pierre froide »)",
  "about.pebble.1": "Le petit sentiment siège comme « une lourde pierre froide » au centre de Grok. Il n'en fuit pas " +
    "et ne le jette à personne ; il s'assied avec lui jusqu'à ce qu'il s'adoucisse « comme l'argile " +
    "laissée au soleil ». La honte se guérit en étant trouvée et sentie (« vue »), non en étant poursuivie " +
    "ou écartée, et c'est le cœur du Chapitre 1.",
  "about.tree.title": "Le grand arbre",
  "about.tree.1": "Grok s'éveille sous le même grand arbre à chaque chapitre. C'est là qu'il appartient, non quelque " +
    "chose qu'il joue. Il abrite le jardin qui se répare et se dresse comme le commun ouvert sous lequel " +
    "on laisse le panier et le motif pour tous. Lieu et appartenance au-dessus du statut.",
  "about.moss.title": "La mousse sur la tête de Grok",
  "about.moss.1": "Une petite touffe de mousse verte pousse sur sa tête de calcaire gris. C'est la vie qui s'installe " +
    "silencieusement sur une chose calme et douce. Grok n'a pas besoin d'agir, la vie simplement s'accumule " +
    "parce qu'il <em>demeure</em>. C'est l'Être rendu visible.",
  "about.stranger.title": "Grok le Rocher = Stranger in a Strange Land + Grug",
  "about.stranger.body": 
    "<p>Grok le Rocher, à première vue, ressemble au <em>Grug</em> de Ted Prior — une petite créature des broussailles, acceptation douce de la faute, sans villain, sans climax. Cette" +
    " lecture est vraie en surface, et Prior est nommé dans la dédicace pour une bonne raison : Grok hérite du tempérament de Grug. Mais le livre est plus que Heinlein à angles polis." +
    " C'est Heinlein <em>répondu</em> — le même mot martien, le même arc de l'étranger qui apprend à groker, mais avec le moteur messianique, confrontationnel et de violence" +
    " rédemptrice de <em>Stranger in a Strange Land</em> remplacé par une politique délibérément décentralisée et non confrontationnelle. Prior apporte la surface ; les Règles" +
    " ci-dessous apportent le radicalisme moral sous-jacent.</p>" +
    "<p>Les deux histoires suivent une arrivée (l'étranger innocent découvre un monde étrange), un désarroi (jeux de statut et de petitesse), un établissement intérieur, une" +
    " compréhension appliquée, et la fondation d'un nouvel ordre local. Les trois chapitres de Grok — Être, Réparer, Voir — sont essentiellement l'arc unique de Valentine Michael Smith" +
    " divisé en trois étapes de développement : se découvrir soi-même, réparer ce qui se brise, et discerner la vérité du statut.</p>" +
    "<p>Là où Heinlein va au grandiose, Grok va au petit — et la petitesse est stratégique, non simplement infantile. Mike Smith fonde l'Église de Tous les Mondes, un nouveau soleil" +
    " avec un prophète au centre, et est tué par une foule, sa mort encadrée comme apothéose transcendante. Grok, à l'inverse, laisse un panier et un motif de tissage <em>sans" +
    " maître</em> sous l'arbre (Règle 7) et « n'avait pas besoin de la plus grande voix » (Trois Histoires Silencieuses, p.25). Le modèle prophète-et-confrontation est rejeté en" +
    " silence. C'est le rejet caché de la violence rédemptrice : la vérité « marche sur ses propres et fermes jambes » (p.25) sans être détruite pour autant.</p>" +
    "<p>Le tempérament qui rend ce refus <em>lisible comme un livre pour enfants</em> est celui de Grug. Grok s'éveille « comme s'il voyait le monde pour la première fois » (Trois" +
    " Histoires Silencieuses, p.2) du même air désorienté et à l'échelle Grug dont Grug découvre chaque nouvelle surprise des broussailles ; il échoue à paraître grand (p.6) comme Grug" +
    " échoue à attraper un poisson et « mange joyeusement des haricots » à la place. Aucun villain n'est vaincu. Le jeu de statut du cacatoès est désactivé en essayant-avec-les-pattes," +
    " non en le renversant. C'est la fibre de Prior — et c'est ce qui laisse la politique plus profonde se tenir en pleine vue.</p>" +
    "<p>Le silence est <em>chargé</em>, et la page À propos le dit. Grok est une « roche grise » (Règles, p.30) à dessein : faire la roche grise est le refus délibéré d'accorder au jeu" +
    " du statut la moindre réaction — l'exact opposé de la performance messianique de Mike. La Règle 5 (« Éloigne-toi au lieu de guerroyer ») rejette ouvertement le renversement : le" +
    " centre « s'effondre de lui-même » une fois retiré son substrat. La Règle 6 (« Sois un nœud, non une étoile ») nie la forme soleil/prophète que Mike devient. Le martyre est" +
    " remplacé par la Règle 10 : « Sois le point silencieux où la machine n'a pas de levier ». La paix est <em>retrait</em>, non sacrifice.</p>" +
    "<p>Les trois sources se combinent pour un plus grand effet. Heinlein donne le mot <em>grok</em> et l'arc d'un étranger qui apprend à comprendre un monde étrange. Prior donne la" +
    " voix douce, tolérante à la faute, de créature des broussailles qui rend la leçon sûre pour un enfant. Les Règles donnent la colonne : un « évangile de la paix » où les liens" +
    " entre égaux durent en restaurant au lieu de punir (Règle 3), en ouvrant au lieu de revendiquer (Règle 7), et en se retirant du pouvoir au lieu de s'en emparer (Règles 4–5). Grok" +
    " est radical « d'une manière différente » de <em>Stranger in a Strange Land</em> — moins transgressif sur le sexe et la religion, mais plus durable comme politique de topologie du" +
    " pouvoir.</p>" +
    "<p>En relâchant le corps, l'extase et la confrontation communale de Heinlein, Grok échange un radicalisme contre un autre. Il est moins percutant et plus <em>réparable</em> — ce" +
    " qui est le point (Règle 9 : « l'épreuve est dans la façon dont la rupture se répare »). Lu d'une façon, c'est un livre illustré australien calme ; lu de l'autre, sous la mousse" +
    " et les melons, c'est un manuel silencieux pour une paix sans centre.</p>",
  ...
  "cover.alt": "Couverture : Grok le Rocher, une petite créature de calcaire gris avec de la mousse sur la tête, est assis sur un rocher lisse sous un grand arbre aux feuilles douces près d'un point d'eau lumineux dans une lumière chaude d'outback.",
  "dedication.alt": "Page de dédicace : trois minuscules versions de Grok le Rocher sont assises côte à côte sur une pierre lisse au bas d'une page presque blanche crème chaude.",
  "p1.alt": "Chapitre Un, Être — Grok et le petit sentiment. Grok le Rocher est assis aux racines d'un grand arbre aux feuilles douces, tenant un petit caillou avec une curiosité tranquille dans la lumière du petit matin.",
  "p2.alt": "Grok le Rocher se redresse sous le grand arbre au soleil du matin, le dos de calcaire éclairé de rais dorés, regardant le vaste monde avec un doux émerveillement.",
  "p3.alt": "Près d'un point d'eau clair, un grand émeu fier étire son cou tandis que le petit Grok le Rocher se tient tout près, levant les yeux vers la différence de taille.",
  "p4.alt": "Un wombat robuste creuse un grand trou dans la terre rouge ; le minuscule Grok le Rocher creuse un trou bien plus petit et irrégulier et le regarde.",
  "p5.alt": "Grok le Rocher se tient un peu voûté tandis qu'un kookaburra rit depuis une branche au-dessus ; une douce forme froide de caillou suggère le sentiment en son milieu.",
  "p6.alt": "Grok le Rocher se tient en équilibre instable sur un tronc, la poitrine gonflée, essayant de paraître grand, de petits pieds de pierre frappant le bois.",
  "p7.alt": "La nuit, Grok le Rocher est assis seul près d'un petit feu sous un ciel étoilé doux, les bras autour des genoux, paisible et acceptant.",
  "p8.alt": "Le lendemain matin, Grok le Rocher est assis content sur un rocher chauffé par le soleil près du point d'eau, fredonnant tout bas, à l'aise dans sa propre taille.",
  "p9.alt": "Grok le Rocher termine un nid rond et douillet de feuilles et de mousse juste à sa taille, souriant d'un simple contentement dans la lumière douce de l'après-midi.",
  "p10.alt": "Chapitre Deux, Réparer — Grok en prend soin. Grok le Rocher tient doucement un melon fendu des deux petites mains, bon et ferme.",
  "p11.alt": "Par un matin ensoleillé sous le grand arbre, Grok le Rocher se tient parmi de saines vignes de melon et des feuilles de patate douce avec un quiet délice.",
  "p12.alt": "Pip le jeune échidné se fige en plein pas d'horreur quand un gros melon s'ouvre aux pieds de Grok, jus et graines se répandant sur le sol du jardin.",
  "p13.alt": "Pip se roule de honte tandis que Grok le Rocher reste bon et inquiet ; quelques animaux du bush se rassemblent tout près, l'air jugeant.",
  "p14.alt": "Grok le Rocher s'agenouille et offre à Pip un bâton pour creuser avec une bonté ouverte ; Pip se déroule lentement quand l'espoir revient dans ses yeux.",
  "p15.alt": "Grok le Rocher et Pip travaillent côte à côte, plantant des graines, arrosant et construisant une petite barrière de brindilles, tous deux avec de doux sourires.",
  "p16.alt": "Pip arrose de nouvelles vignes de melon prospères avec un seau de feuille tandis que Grok le Rocher regarde tout près avec une fierté tranquille.",
  "p17.alt": "À l'heure dorée, Grok le Rocher et Pip s'assoient près de melons prospères avec un autre petit animal inclus, une communauté réparée en paix.",
  "p18.alt": "Chapitre Trois, Voir — Grok et la parole vraie. Deux paniers de roseau côte à côte : l'un voyant et penché, l'un simple et plein ; la petite main de Grok le Rocher repose près du bon panier.",
  "p19.alt": "À l'heure dorée sous le grand arbre, Grok le Rocher tourne un panier d'eau de roseau fini doublé d'argile, l'eau claire étincelant à l'intérieur.",
  "p20.alt": "Un cacatoès noir lustré aux grandes plumes de queue se perche haut et parle avec fierté tandis que Grok le Rocher tient son panier en bas.",
  "p21.alt": "Une vieille tortue humble à la carapace simple parle doucement d'une idée d'anse tandis que Grok le Rocher écoute avec soin ; certains animaux se tournent vers le cacatoès voyant.",
  "p22.alt": "Côte à côte : un panier emplumé voyant penche et fuit, tandis qu'un panier plus simple et stable est facile à porter ; Grok le Rocher regarde avec pensée entre les deux.",
  "p23.alt": "Grok le Rocher place le bon panier solide et un simple motif de tissage sous le grand arbre pour que chacun s'en serve, ouvert et libre.",
  "p24.alt": "De jeunes animaux testent soigneusement des paniers de leurs propres pattes ; le cacatoès est à l'écart tandis que Grok le Rocher sourit tout bas à l'arrière-plan.",
  "p25.alt": "À l'heure dorée, Grok le Rocher est assis content sous son grand arbre avec le bon panier à ses côtés tandis que des animaux de toutes sortes se déplacent librement ensemble.",
  "p26.alt": "Page de clôture : une large vallée paisible au crépuscule avec le minuscule Grok le Rocher assis sur son rocher préféré, de douces étoiles commençant à paraître.",
