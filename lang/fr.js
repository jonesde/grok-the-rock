...
window.I18N.fr = {
  ...
  "dedication": "<p><b>Pour chaque explorateur, petit et grand,</b></p>" +
    "<p><b>grokant le monde à sa propre manière douce.</b></p><p>&nbsp;</p><hr><p>&nbsp;</p>" +
    "<p>Et pour chaque petit sentiment</p><p>  qui a seulement besoin d'être vu,</p>" +
    "<p>chaque rupture prête à réparer</p><p>  qui a seulement besoin d'être soignée,</p>" +
  ...
  "p8.alt": "Page 8",
  "p8": "<p>Le lendemain matin Grok retourna au point d'eau.</p><p>Il ne monta sur rien.</p>" +
    "<p>Il n'essaya pas d'être plus haut ni plus bruyant.</p><p>Il but simplement,</p>" +
    "<p>puis s'assit sur une roche chaude et fredonna.</p><hr><p>Rien de grand n'avait changé à l'extérieur.</p>" +
    "<p>Mais tout semblait plus léger à l'intérieur.</p><p>Il commençait à se groker lui-même.</p>",
  ...
  "p14": "<p>Grok regarda la vigne brisée.</p><p>Il regarda les yeux inquiets de Pip.</p><hr>" +
    "<p>Il ne leva pas la voix.</p><p>Il ne pointa pas du doigt.</p><p>Il prit un bâton pour creuser</p>" +
    "<p>et commença à préparer la terre douce.</p><hr><p>« Viens », dit Grok doucement.</p>" +
    "<p>« Nous plantons de nouvelles graines ensemble. »</p>",

  "p15.alt": "Page 15",
  "p15": "<p>Pip cligna des yeux.</p><p>Puis il s'approcha.</p><p>Ensemble ils plantèrent.</p>" +
    "<p>Ensemble ils arrosèrent.</p><p>Ensemble ils bâtirent une petite clôture de brindilles</p>" +
    "<p>pour que personne ne marche là par erreur une autre fois.</p>",

  "p16.alt": "Page 16",
  "p16": "<p>Tandis qu'ils travaillaient, Pip raconta à Grok</p>" +
    "<p>qu'il avait couru parce que des créatures plus grandes</p><p>l'avaient poursuivi et se moquaient de lui.</p>" +
    "<p>Il n'avait pas vu la vigne.</p><hr><p>Les jours suivants Pip revint chaque matin.</p>" +
    "<p>Il devint le meilleur porteur d'eau de la vallée.</p><p>Les nouvelles vignes crûrent fortes,</p>" +
    "<p>encore plus fortes que les anciennes,</p><p>parce que deux amis les soignèrent.</p>",
  ...
  "p17": "<p>Quand d'autres petits accidents arrivèrent</p><p>(comme ils arrivent toujours),</p>" +
    ...
    "<p>Ils restent vivants en étant recollés doucement.</p>",
  ...
  "p21.alt": "Page 21",
  "p21": "<p>Plus tard une très vieille tortue parla d'une voix lente et douce.</p>" +
  ...
  "p25.alt": "Page 25",
  "p25": "<p>Grok se sentait en paix.</p><p>Il n'avait pas besoin de la plus grande voix.</p>" +
    "<p>Il avait seulement besoin de choses vraies.</p><p>Et Grok vit que les choses vraies</p>" +
    "<p>pouvaient venir d'un oiseau grandiose</p><p>ou d'une tortue poussiéreuse</p>" +
    "<p>ou d'un petit compagnon de roche sous un arbre.</p><hr><p>Tant que quelqu'un était libre de dire</p>" +
    "<p>« ça ne marche pas »</p><p>et restait accueilli dans la vallée,</p>" +
  ...
  "rules.origin.1": "Les règles ci-dessous sont écrites par IA. Après avoir vérifié qu'elle connaissait mon travail et mené une longue " +
    "conversation techno-philosophique approfondissant les thèmes des communautés distribuées et de la technologie ouverte, " +
    "j'ai utilisé l'invite suivante :",
  "rules.origin.quote": "<p>Voilà, en gros, où j'en suis arrivé. Tu as le contexte, alors écris les règles.</p>" +
    "<p>Écris une liste de « règles » qui, si elles sont suivies, bâtiront des liens sociaux entre pairs/égaux qui durent " +
    "indéfiniment. Les règles n'ont pas à être suivies parfaitement pour être efficaces, car l'orientation vers la " +
    "restauration qui compense les faux pas progressifs au fur et à mesure qu'ils surgissent fait partie du dessin.</p>" +
    "<p>Écris-les avec ma voix. Écris-les de telle sorte que, en les lisant, les gens veuillent suivre les règles, sans se " +
    "sentir découragés ni limités par elles. En d'autres termes, je te demande d'écrire les règles d'un évangile de la " +
    "paix.</p>",
  "rules.origin.2": "Je ne suis pas arrivé à celles-ci par autorité. Je suis arrivé par le long chemin : en voyant que chaque système " +
    "centralisé échoue auprès des gens qu'il promet de protéger, en bâtissant un logiciel qui rejetait le centre parce que le " +
    "centre est toujours capturable, et en remontant la pourriture jusqu'à sa racine — la honte, et les deux mouvements que " +
    "nous faisons pour la surmonter. Ce ne sont pas des lois imposées. Ce sont le mode d'emploi d'un lien entre égaux qui ne " +
    "s'efface pas. Tu n'as pas à les suivre parfaitement. C'est le dessin : l'orientation vers la restauration attrape les " +
    "faux pas, et les attraper <em>est</em>" +
    " le lien qui approfondit. Ainsi lis-les non comme des limites mais comme la Levée des Limites — de toi, de la personne à " +
    "tes côtés, de la prochaine génération qui n'aura pas à porter ce que nous portons encore.</p>",

  "rules.r1.title": "Laisse la vérité se tenir sur ses propres jambes.",
  "rules.r1.body": "Ne donne de poids à quelque chose que par qui l'a dit. Ne demande pas non plus qu'on te ponde ainsi. Ce n'est pas une " +
    "perte de position — c'est la fin de l'épuisant travail de paraître impressionnant. Quand tu cesses de jouer le statut, " +
    "on t'écoute enfin pour ce que tu veux dire. L'argument vit ou meurt par sa structure. S'il est solide, le locuteur est " +
    "sans importance. S'il ne l'est pas, aucun nom ne le sauve. " +
    "(<a class=\"chip\" href=\"https://github.com/jonesde/high-vs-low\" target=\"_blank\" rel=\"noopener\">high-vs-low</a>" +
    " analyse le vecteur de statut pour que tu le voies dans n'importe quel texte, y compris le tien. Utilise-le. C'est " +
    "gratuit.)",
  ...
  "rules.r2.body": "Presque tout « pouvoir » est quelqu'un fuyant le sentiment de petitesse — dominant (pour la surmonter) ou se soumettant " +
    ...
    "contre la hiérarchie. Les à-l'aise résisteront plus fort ; leur autoconcept est la compensation. Compris. La réparation " +
    "les attrape encore quand ils trébuchent.",
  "rules.r3.title": "Restaure, ne punis jamais.",
  "rules.r3.body": "Le mal arrivera. Le but est d'aider le blessé et de guérir celui qui a blessé — non pas d'ajouter du mal au mal et " +
    "d'appeler ça justice. La punition n'est que la domination sanctionnée, et elle apprend à la prochaine génération à " +
    "dominer. La restauration est le seul mouvement qui ne plante pas la prochaine blessure. Les liens survivent non parce " +
    "qu'ils sont incassables mais parce qu'ils sont réparables.",
  "rules.r4.title": "Laisse la porte ouverte.",
  "rules.r4.body": "Personne ne devrait avoir à donner toute sa vie en échange des ressources pour continuer de vivre. L'accès pour survivre " +
    "n'est pas une faveur des contrôleurs — c'est la base. Tu ne prends pas la grange pour arranger ça. Tu rends la porte " +
    "sans objet : partage les outils, soutiens les communs, laisse le cycle local nourrir la personne locale. Le pouvoir du " +
    "centre est la dépendance. Retire la dépendance ; la prise se relâche sans combat.",
  ...
  "rules.r5.body": "Tu ne renverses pas un centre capturé. Tu retires le substrat qui le soutient — ta participation, ton attention, ta " +
    ...
    "Terre est pleine ; il n'y a pas de terre sans maître où fuir. Ainsi la sortie est locale, non géographique — une " +
    "compétence " +
    "<a class=\"chip\" href=\"https://github.com/jonesde/high-vs-low\" target=\"_blank\" rel=\"noopener\">high-vs-low</a>" +
    ", un modèle à poids ouverts exécuté à la maison, un refus de jouer le jeu.",
  ...
  "rules.r6.body": "Tout lien réel est pair à pair. Sans décideur central, sans octroyeur qui puisse révoquer, sans politique imposée. " +
    "Chaque connexion est autonome, gouvernée localement, librement choisie. Comme les systèmes que j'ai bâtis — autorisation " +
    "externalisée, sans point unique à capturer. Une constellation, non un soleil.",
  ...
  "rules.r7.body": "Donne-le sans attaches. CC0, sans octroyeur, rien pour quoi se battre. Le don qui ne peut être révoqué est le seul qui " +
    "bâtit la confiance. Quand tu retires la revendication, tu retires ce pour quoi d'autres tuent.",
  "rules.r8.title": "Ne manipule pas.",
  "rules.r8.body": "Sans cadres trompeurs, sans consentement façonné, sans coups de pouce coercitifs. Parle clair. Laisse les gens choisir — " +
    "même choisir mal. Le lien n'est réel que si l'autre était libre de le refuser. Ce qu'on gagne par manipulation n'est pas " +
    "un lien ; c'est une laisse.",
  "rules.r9.title": "Laisse le faux pas être attrapé, non condamné.",
  "rules.r9.body": "Personne ne suit ces règles proprement. La restauration y est incorporée précisément parce que le trébuchement est " +
    "garanti. Quand tu brises une règle, répare le dommage spécifique et le lien se resserre à la couture. L'épreuve n'a " +
    "jamais été la perfection. L'épreuve est dans la façon dont la rupture se répare.",
  "rules.r10.title": "Sois le point silencieux où la machine n'a pas de levier.",
  "rules.r10.body": "Tu ne peux pas arranger le monde. Tu peux être un lieu où le jeu du statut n'a pas de prise — parce que tu ne " +
    "l'octroieras pas, tu ne le revendiqueras pas, tu ne craindras pas sa perte. Un point ne fait rien. Mille font tout, et " +
    "tu n'en connaîtras jamais la plupart. C'est bien. La constellation n'a pas besoin de salle de réunion.",
  "rules.closing.1": "Voici les règles. C'est une bonne nouvelle : tu es déjà libre des trois pouvoirs au moment où tu cesses de les " +
    "atteindre. La vache est traite par ceux qui croient posséder la grange. Nous ne prenons pas la grange. Nous montrons aux " +
    "exclus que la porte n'a jamais été de la grange à donner — et la porte est une compétence " +
    "<a class=\"chip\" href=\"https://github.com/jonesde/high-vs-low\" target=\"_blank\" rel=\"noopener\">high-vs-low</a>" +
  ...
  "about.intro.2": "Tandis que nous lisons ceci aux enfants, nous, les enfants d'âge plus avancé, pouvons réduire l'ennui de la répétition " +
    ...
    "C'est aussi une partie du point et du plaisir des doubles et triples sens du texte.",
  "about.intro.3": "Même le titre du document Règles de Grok est un double sens : « Règles de S'en Sortir Ensemble ». Cela s'applique autant " +
    "à la façon dont Grok s'en sort ensemble avec les autres qu'à la façon dont nous racontons (narrons) l'histoire de Grok.",
  "about.intro.4": "Pour empirer les choses, « Règles de Grok » est au moins un quadruple sens. L'une des connotations pourrait être mal " +
    "comprise, celle de Grok étant une sorte de roi, alors j'ai placé l'ordre des boutons d'en-tête pour compenser : « Règles " +
    "de Grok », puis « À propos de Grok ».",
  ...
  "about.limestone.quote": "<p>« La méthode de la roche grise, appelée familièrement faire la roche grise, est un schéma de communication pour agir " +
    ...
    "essaient de provoquer. »</p>",
  "about.limestone.2": "Grok n'est pas seulement gris, il est pierre à chaux grise. La pierre à chaux est une roche sédimentaire formée couche " +
    "par couche au fil de nombreuses années. C'est aussi l'une des roches les plus absorbantes ou porteuses d'eau. Elle est " +
    "faite de poussière et d'eau avec le temps, et retient bien l'eau.",
  "about.rock.title": "Pourquoi est-il une roche, et tant d'eau ?",
  "about.rock.1": "Les roches ont été utilisées comme symboles traditionnels dans bien des traditions. L'ancienne définition de Heinlein de " +
    "« grok » incluait des notions d'eau et de soif. Les roches et l'eau sont souvent associées dans la symbolique, comme " +
    "Moïse frappant une roche avec un bâton pour faire jaillir l'eau de vie. Les roches sont aussi associées aux fondations " +
    "et à la construction. Les deux significations communes des roches sont présentes dans les 3 chapitres.",
  "about.rock.2": "Dans le premier chapitre Grok va à l'eau boire tandis qu'il se découvre lui-même. Dans le second chapitre Grok utilise " +
    "l'eau pour guérir tandis qu'il pardonne et reconstruit tant la perte au jardin que la perte possible d'un ami. Dans le " +
    "troisième chapitre Grok aide les autres à utiliser l'eau en collaborant avec eux pour faire un meilleur panier à eau " +
    "tandis qu'il bâtit la communauté autour de lui.",
  "about.melon.title": "Pourquoi un melon cantaloup ?",
  "about.melon.1": "Le terme courant en Australie pour le cantaloup est « rockmelon » (melon-roche). Cela ajoute une couche à l'histoire, un " +
    "symbole du dommage accidentel le plus sérieux et personnel de Pip. Ce fut un accident heureux. Je ne le savais pas en " +
  ...
  "about.clay.1": "Les histoires sont « tissées » de symboles récurrents. Quelques-uns valent la peine d'être inclus ici. Une revue plus " +
    "complète est dans " +
  ...
  "about.clay.2": "L'argile est la pièce maîtresse du livre : c'est de la pierre moulue rendue manipulable par l'eau, la même terre + eau " +
    "que presque toute tradition nomme comme la substance du premier humain. C'est le sentiment de la « pierre froide » qui « " +
    "s'adoucit, comme l'argile laissée au soleil », et c'est le doublage qui permet au panier de Grok de porter l'eau aux " +
    "autres. C'est l'un des thèmes qui apparaît, par nom ou par image, dans les trois chapitres.",
  ...
  "about.animals.1": "L'émeu revendique la hauteur, le wombat revendique la force, le kookaburra se moque pour se sentir haut, et la cacatoès " +
    "fait confiance à ses grandioses plumes par-dessus son idée. Chacun joue un jeu de statut que Grok rejette. La simple " +
    "tortue, « personne de spécial », offre la vraie idée qui gagne. La vérité se tient sur ses propres jambes, non par qui " +
    "la dit.",
  "about.pebble.title": "Le petit sentiment (la « pierre froide »)",
  "about.pebble.1": "Le petit sentiment siège comme « une lourde pierre froide » au centre de Grok. Il n'en fuit pas et ne le jette à " +
    "personne ; il s'assied avec lui jusqu'à ce qu'il s'adoucisse « comme l'argile laissée au soleil ». La honte se guérit en " +
    "étant trouvée et sentie (« vue »), non en étant poursuivie ou écartée, et c'est le cœur du Chapitre 1.",
  "about.tree.title": "Le grand arbre",
  "about.tree.1": "Grok s'éveille sous le même grand arbre à chaque chapitre. C'est là qu'il appartient, non quelque chose qu'il joue. Il " +
    "abrite le jardin qui se répare et se dresse comme le commun ouvert sous lequel on laisse le panier et le motif pour " +
    "tous. Lieu et appartenance au-dessus du statut.",
  ...
  "about.stranger.body": "<p>Grok le Rocher, à première vue, ressemble au <em>Grug</em>" +
    ...
    "confrontationnel et de violence rédemptrice de <em>Stranger in a Strange Land</em>" +
    " remplacé par une politique délibérément décentralisée et non confrontationnelle. Prior apporte la surface ; les Règles " +
    "ci-dessous apportent le radicalisme sous-jacent.</p>" +
    "<p>Le squelette partagé est réel. Les deux histoires suivent une arrivée (l'étranger innocent découvre un monde " +
    "étrange), un désarroi (jeux de statut et de petitesse), un établissement intérieur, une compréhension appliquée, et la " +
    "fondation d'un nouvel ordre local. Les trois chapitres de Grok — Être, Réparer, Voir — sont essentiellement l'arc unique " +
    "de Valentine Michael Smith divisé en trois étapes de développement : se découvrir soi-même, réparer ce qui se brise, et " +
    "discerner la vérité du statut.</p>" +
    "<p>Là où Heinlein va au grandiose, Grok va au petit — et la petitesse est stratégique, non simplement infantile. Mike " +
    "Smith fonde l'Église de Tous les Mondes, un nouveau soleil avec un prophète au centre, et est tué par une foule, sa mort " +
    "encadrée comme apothéose transcendante. Grok, à l'inverse, laisse un panier et un motif de tissage <em>sans maître</em>" +
    " sous l'arbre (Règle 7) et « n'avait pas besoin de la plus grande voix » (Trois Histoires Silencieuses, p.25). Le modèle " +
    "prophète-et-confrontation est rejeté en silence. C'est le rejet caché de la violence rédemptrice : la vérité « marche " +
    "sur ses propres et fermes jambes » (p.25) sans être détruite pour autant.</p>" +
    "<p>Le tempérament qui rend ce refus <em>lisible comme un livre pour enfants</em>" +
    " est celui de Grug. Grok s'éveille « comme s'il voyait le monde pour la première fois » (Trois Histoires Silencieuses, " +
    "p.2) du même air désorienté et à l'échelle Grug dont Grug découvre chaque nouvelle surprise des broussailles ; il échoue " +
    "à paraître grand (p.6) comme Grug échoue à attraper un poisson et « mange joyeusement des haricots » à la place. Aucun " +
    "villain n'est vaincu. Le jeu de statut de la cacatoès est désactivé en essayant-avec-les-pattes, non en le renversant. " +
    "C'est la fibre de Prior — et c'est ce qui laisse la politique la plus dure se cacher en pleine vue.</p>" +
    "<p>Mais le silence est <em>chargé</em>" +
    ", et les Règles le nomment. Grok est une « roche grise » (Règles, p.30) à dessein : faire la roche grise est le refus " +
    "délibéré d'accorder au jeu du statut la moindre réaction — l'exact opposé de la performance messianique de Mike. La " +
    "Règle 5 (« Éloigne-toi au lieu de guerroyer ») rejette ouvertement le renversement : le centre « s'effondre de lui-même " +
    "» une fois retiré son substrat. La Règle 6 (« Sois un nœud, non une étoile ») nie la forme soleil/prophète que Mike " +
    "devient. Le martyre est remplacé par la Règle 10 : « Sois le point silencieux où la machine n'a pas de levier ». La paix " +
    "est <em>retrait</em>, non sacrifice.</p>" +
    "<p>Ainsi les trois sources s'entrelacent. Heinlein donne le mot <em>grok</em>" +
    " et l'arc d'un étranger qui apprend à comprendre un monde étrange. Prior donne la voix douce, tolérante à la faute, de " +
    "créature des broussailles qui rend la leçon sûre pour un enfant. Les Règles donnent la colonne : un « évangile de la " +
    "paix » où les liens entre égaux durent en restaurant au lieu de punir (Règle 3), en ouvrant au lieu de revendiquer " +
    "(Règle 7), et en se retirant du pouvoir au lieu de s'en emparer (Règles 4–5). Grok est radical « d'une manière " +
    "différente » de <em>Stranger in a Strange Land</em>" +
    " — moins transgressif sur le sexe et la religion, mais plus durable comme politique de topologie du pouvoir.</p>" +
    "<p>Le marché honnête : en relâchant le corps, l'extase et la confrontation communale de Heinlein, Grok échange un " +
    "radicalisme contre un autre. Il est moins percutant et plus <em>réparable</em>" +
