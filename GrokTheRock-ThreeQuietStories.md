...
**Image generation prompt:**
Almost blank warm cream page. At the centre bottom: three tiny versions of Grok the Rock (small friendly limestone pebble-creatures with little moss tops) sitting side-by-side on a smooth stone, looking outward with soft curiosity. Very minimal, generous open space, soft morning light wash. Delicate tiny ferns or spinifex at the edges. Calm, quiet, inviting negative space above for dedication text. Portrait children’s book page.
